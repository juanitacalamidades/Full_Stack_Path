...
1 - Create a generateTarget() function. This function will be called 
...
/**
 ...
 2- Create a compareGuesses() function. This function will be called each round 
    to determine which guess is closest to the target number.
        This function:

        Has three parameters representing the user (human) guess, a computer guess, 
        and the secret target number to be guessed.
...
const compareGuesses = (humanGuess, computerGuess, targetGuess) => {
    ...
    // humanGuess === computerGuess || humanGuess < computerGuess ? console.log('human wins!') : console.log(false)
...
//console.log(compareGuesses(1, 3, 6));
...
/** ---EXTEND PROJECT---
 * If you’d like to extend your project on your own, you could consider the following:
